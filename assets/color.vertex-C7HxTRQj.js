...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l={name:s,shader:c},u=`fogVertexDeclaration`,d=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var f={name:u,shader:d},p=`instancesDeclaration`,m=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h={name:p,shader:m},g=`instancesVertex`,_=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x={name:y,shader:b},S=`bakedVertexAnimation`,C=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=C);var w={name:S,shader:C},T=`clipPlaneVertex`,E=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D={name:T,shader:E},O=`fogVertex`,k=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N={name:j,shader:M},P=`colorVertexShader`,F=`attribute position: vec3f;
#ifdef VERTEXCOLOR
...
}`;e.ShadersStoreWGSL[P]||(e.ShadersStoreWGSL[P]=F);var I=[r,o,l,f,h,v,x,w,D,A,N];for(let t of I)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var L={name:P,shader:F};export{L as colorVertexShaderWGSL};
//# sourceMappingURL=color.vertex-C7HxTRQj.js.map